...
def main(config, qa_data_path, corpus_data_path, project_dir):
    ...
    # autorag.embedding_models['KoSimCSE-roberta'] = autorag.LazyInit(HuggingFaceEmbedding, model_name="BM-K/KoSimCSE-roberta")
    # autorag.embedding_models['paraphrase-multilingual-mpnet-base-v2'] = autorag.LazyInit(HuggingFaceEmbedding, model_name="sentence-transformers/paraphrase-multilingual-mpnet-base-v2")
    # autorag.embedding_models['paraphrase-multilingual-MiniLM-L12-v2'] = autorag.LazyInit(HuggingFaceEmbedding, model_name="sentence-transformers/paraphrase-multilingual-MiniLM-L12-v2")
    # autorag.embedding_models['multilingual-e5-large-instruct'] = autorag.LazyInit(HuggingFaceEmbedding, model_name="intfloat/multilingual-e5-large-instruct")
    # autorag.embedding_models['upstage_embed'] = autorag.LazyInit(UpstageEmbedding)
    # autorag.embedding_models['cohere_embed'] = autorag.LazyInit(CohereEmbedding, model_name="embed-multilingual-v3.0",api_key=os.getenv('COHERE_API_KEY'))
    # autorag.embedding_models['KU-HIAI-ONTHEIT-large-v2.1'] = autorag.LazyInit(HuggingFaceEmbedding, model_name="KU-HIAI-ONTHEIT/ontheit-large-v1_1")
    # autorag.embedding_models['KU-HIAI-ONTHEIT-large-v2'] = autorag.LazyInit(HuggingFaceEmbedding, model_name="KU-HIAI-ONTHEIT/ontheit-large-v2")
    ...
    # autorag.embedding_models['KoE5'] = autorag.LazyInit(HuggingFaceEmbedding, model_name="nlpai-lab/KoE5",trust_remote_code=True)
